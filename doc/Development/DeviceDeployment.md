...
```bash
rosinstall_generator ros_comm rosbag actionlib sensor_msgs nav_msgs tf2_msgs tf2_tools rosunit --rosdistro noetic --deps --wet-only --tar > noetic-ros_comm-wet.rosinstall
```
