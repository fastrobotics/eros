 ...
 */
#include <eros_window/CommonWindowDefinitions.h>#include "eros_window::CommonWindowUtility.h"
...
TEST(BasicTest, Test_Convert) {
    ...
    auto coord_pixel =
        eros_window::CommonWindowUtility::convertCoordinate(coord_perc, width_pix, height_pix);
...
TEST(BasicTest, Test_NewWindow) {
    auto window = eros_window::CommonWindowUtility::create_newwin(100, 100, 0, 0);
